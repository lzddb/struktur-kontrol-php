...
<head>
    ...
    <title>Minimarket - Kasir</title>
</head>
<body>
    <form method="POST">
        <label >PROMO BULAN INI SEMUA BARANG HARGA DIATAS Rp. 30000 DISKON 7%, DIBAWAH Rp. 30000 DISKON 5%</label> <br><br>
        ...
        <label>Apakah pembeli merupakan member toko ?</label><br>
    ...
    echo "Apakah pembeli merupakan member : " . $member . "<br><br>";
